...
@Profile({"dev", "test"})
public class InitialSeedDB implements CommandLineRunner{

    private final PasswordEncoder passwordEncoder;
    private final UserAccountRepository userAccountRepository;


    public InitialSeedDB(PasswordEncoder passwordEncoder, UserAccountRepository userAccountRepository){
